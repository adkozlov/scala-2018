...
public interface CalcVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CalcParser#parenExp}.
	 *
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParenExp(CalcParser.ParenExpContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link CalcParser#operation}.
	 *
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOperation(CalcParser.OperationContext ctx);
}